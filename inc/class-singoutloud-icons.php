...
class SingOutLoud_Icons
{
	public static function get_icons()
	{
		return apply_filters('estar_icons', [
			...
			'menu'          => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>',
			...
			'star'			=> '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 61.55 58.54"><defs><style>.cls-1{fill:#fff;}</style></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><polygon class="cls-1" points="30.78 0 38.04 22.36 61.55 22.36 42.53 36.18 49.8 58.54 30.78 44.72 11.76 58.54 19.02 36.18 0 22.36 23.51 22.36 30.78 0"/></g></g></svg>',
		]);
	}
