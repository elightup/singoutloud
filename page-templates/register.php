		...
		<div class="container">
			<div class="register-page__wrap">
				<div class="register-page__form">
					<h1>Welcome</h1>
					<?= do_shortcode( '[mb_user_profile_register label_username="Số điện thoại(dùng để đăng nhập)" label_password="Password" label_password2="Confirm Password" label_submit="Sing up" id="

					" confirmation="Tài khoản đăng ký của bạn đang được xem xét chờ duyệt (Thời gian duyệt từ 1-2 ngày )"]' )?>
